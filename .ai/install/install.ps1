...
$configFiles = @('runners.yaml', 'automation.yaml', 'registry.yaml', 'contexts.yaml', 'epics.yaml', 'rules.yaml', 'kit.yaml', 'design-policy.json', 'contracts.json', 'delivery.json', 'architecture.json', 'architecture-fitness.json')
